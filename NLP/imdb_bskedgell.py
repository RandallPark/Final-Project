...
data_dir = "data/TWEETS_bskedgell/"

# URL for the data-set on the internet.
data_url = "data/TWEETS_bskedgell/"
...
def maybe_download_and_extract():
    ...
    download.maybe_download_and_extract(download_dir=data_dir, url=data_url)
...
def load_data(train=True):
    ...
    dir_base = os.path.join(data_dir, "acltweets", train_test_path)
